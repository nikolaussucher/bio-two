...
This is the \textbf{Laboratory Manual} for the Biology II course
(SCI104) at RCC.
...
\section{View the prepared slides
...
\tightlist
\item
  \href{https://en.wikipedia.org/wiki/Peziza}{\emph{Peziza}} apothecium
...
\section{View the prepared slides of
...
(ref:lichens)
\href{https://commons.wikimedia.org/wiki/File:Haeckel_Lichenes.jpg}{Lichens}
...
\caption{(ref:lichens)}\label{fig:lichens}
\end{figure}
...
\caption{(ref:mosses)}\label{fig:mosses}
\end{figure}
...
(ref:moss)
\href{https://commons.wikimedia.org/wiki/File:Lifecycle_moss_svg_diagram.svg}{Life
cycle of mosses.}
...
\caption{(ref:moss)}\label{fig:moss}
\end{figure}
...
(ref:hepatica)
\href{https://commons.wikimedia.org/wiki/File:Haeckel_Hepaticae.jpg}{Liverworts}
from Ernst Haeckel's
\href{https://en.wikipedia.org/wiki/Kunstformen_der_Natur}{Kunstformen
der Natur}, 1904.
...
\caption{(ref:hepatica)}\label{fig:hepatica}
\end{figure}
...
(ref:liverwort)
\href{https://commons.wikimedia.org/wiki/File:Liverwort_life_cycle.jpg}{Life
cycle of liverworts.}
...
\caption{(ref:liverwort)}\label{fig:liverwort}
\end{figure}
...
\item
  Marchantia thallus (Figure \ref{fig:marchantiathallus})
...
\item
  ...
  \end{itemize}
\item
  Marchantia antheridia (Figure \ref{fig:marchantiaantheridia})
  ...
  \end{itemize}
\item
  Marchantia sporophyte (Figure \ref{fig:marchantiasporophyte})
  ...
  \end{itemize}
\item
  Marchantia gemma cup (Figure \ref{fig:gemma})
...
\caption{(ref:ferns)}\label{fig:ferns}
\end{figure}
...
vascular plants that reproduce by spores rather than seeds. Equisetum is
...
\section{View Prepared Slides of
Equisetum}\label{view-prepared-slides-of-equisetum}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Equisetum strobilus (Figure \ref{fig:equisetumstrobilus})
...
\href{https://en.wikipedia.org/wiki/Psilotum}{Psilotum} is a genus of
...
\section{View Prepared Slides of
Psilotum}\label{view-prepared-slides-of-psilotum}
...
\section{View Prepared Slides of
Cyrtomium}\label{view-prepared-slides-of-cyrtomium}
...
islands (Hawaii). Cyrtomium falcatum is a species of fern known by the
...
(ref:flower)
\href{https://commons.wikimedia.org/wiki/File:Mature_flower_diagram.svg}{Anatomy
of the flower.}
...
\caption{(ref:flower)}\label{fig:flower}
\end{figure}
...
(ref:angiosperm)
\href{https://commons.wikimedia.org/wiki/File:Angiosperm_life_cycle_diagram-en.svg}{Life
...
\caption{(ref:angiosperm)}\label{fig:angiosperm}
\end{figure}
...
though their range extends into the northern subtropics. L ilies are
...
\caption{Sponges and corals.}\label{fig:spicules}
\end{figure}
...
(ref:chrysaora)
\href{https://en.wikipedia.org/wiki/Chrysaora_colorata}{Purple striped
jellyfish \emph{Chrysaora colorata}.}
...
\caption{(ref:chrysaora)}\label{fig:chrysaora}
\end{figure}
...
\caption{(ref:anthopleura)}\label{fig:anthopleura}
\end{figure}
...
(ref:nematocyst)
\href{https://commons.wikimedia.org/wiki/File:Hydra_nematocyst_firing_01.png}{A
firing hydra nematocyst.}
...
\caption{(ref:nematocyst)}\label{fig:nematocyst}
\end{figure}
...
\caption{(ref:hydra)}\label{fig:hydra}
\end{figure}
...
\href{https://en.wikipedia.org/wiki/Aurelia_(name)}{Aurelia} is a genus
...
\section{View Prepared Slides of
Aurelia}\label{view-prepared-slides-of-aurelia}
...
\href{https://en.wikipedia.org/wiki/Obelia}{Obelia} is a genus in the
...
is also called sea fur. Obelia has a worldwide distribution except the
high-arctic and Antarctic seas. The medusa stage of Obelia species are
common in coastal and offshore plankton around the world. Obelia are
...
(ref:obelia)
\href{https://commons.wikimedia.org/wiki/File:Obelia_geniculata.jpg}{\emph{Obelia
geniculata} colony with 3 hydranths and 2 gonophores.}
...
\caption{(ref:obelia)}\label{fig:obelia}
\end{figure}

\section{View Prepared Slides of
Obelia}\label{view-prepared-slides-of-obelia}
...
\section{View Prepared Slides of
Metridium}\label{view-prepared-slides-of-metridium}
...
\tightlist
\item
  Planaria (\emph{Dugesia}) w.m. (Figure \ref{fig:dugesia})
  ...
  \end{itemize}
\item
  Planaria (\emph{Dugesia}) x.s. 3 regions (Figure \ref{fig:dugesiaxs})
...
\section{\texorpdfstring{\emph{Cestoda}}{Cestoda}}\label{cestoda}
...
of blood flukes (Schistosoma). The adult lives in the blood vessels
...
leading cause of schistosomiasis in the world, it is the most prevalent
parasite in humans. It is classified as a neglected tropical disease. As
of 2016, 206.5 million people have schistosomiasis and S. mansoni is the
...
asexual reproductive takes place. S. mansoni is transmitted through
water, where freshwater snails of the genus Biomphalaria act as
...
in Egypt in 1851, while discovering S. haematobium. Sir Patrick Manson
...
production (\textgreater{}32 days). The S. mansoni parasites are found
...
(ref:ascidians)
\href{https://commons.wikimedia.org/wiki/File:Haeckel_Ascidiae.jpg}{Ascicians}
...
\caption{(ref:ascidians)}\label{fig:ascidians}
\end{figure}
...
(ref:epithelium)
\href{https://commons.wikimedia.org/wiki/File:Illu_epithelium.jpg}{Types
of epithelia}
...
\caption{(ref:epithelium)}\label{fig:epithelium}
\end{figure}
...
(ref:skin)
\href{https://commons.wikimedia.org/wiki/File:Skin.png}{Anatomy of human
skin.}
...
\caption{(ref:skin)}\label{fig:skin}
\end{figure}
...
(ref:bone)
\href{https://commons.wikimedia.org/wiki/File:Illu_compact_spongy_bone.jpg}{Compact
and spongy bone.}
...
\caption{(ref:bone)}\label{fig:bone}
\end{figure}
...
(ref:skeleton)
\href{https://commons.wikimedia.org/wiki/File:Human_skeleton_front_en.svg}{The
human skeleton.}
...
\caption{(ref:skeleton)}\label{fig:skeleton}
\end{figure}
...
\tightlist
\item
  Frog early cleavage (Figure \ref{fig:cleavage}) * Count the cells in
  this early from embryo.
\item
  Frog blastula (Figure \ref{fig:blastula})
\item
  Frog gastrulation: yolk plug stage (Figure \ref{fig:plug}) * Locate:
  yolk plug, ectoderm, endoderm, archenteron (gastrocoel)
\item
  Frog gastrula (Figure \ref{fig:gastrula})
\item
  Frog early neural groove x.s. (Figure \ref{fig:groove}) * Locate
  neural groove, ectoderm, endoderm, mesoderm, archenteron, location of
  presumptive notochord
\item
  Frog late neural tube x.s. (Figure \ref{fig:tube}) * Locate: neural
...
\item
  Chick embryo 72 hrs (Figure \ref{fig:chick72h}). * Locate: same
  structures as above plus; allantois, hind limb bud.
\item
  Chick Embryo 96 hrs (Figure \ref{fig:chick96h}). * Locate: same
  structures as above.
\end{enumerate}
...
\tightlist
\item
  Cat ovary (Figure \ref{fig:ovary}) * Identify primary, secondary and
  Graffian follicles
\item
  Graafian follicle (Figure \ref{fig:graafian}).
\item
  Cat ovary Corpus Luteum * Locate corpus luteum
\item
  Uterus (Figure \ref{fig:uterus}) * Identfy: endometrium, myometrium,
  perimetrium
\item
  Monkey testis (Figure \ref{fig:monkeytestis}) * Locate: semimiferous
  tubules, spermatozoa
\item
  Human testis (Figure \ref{fig:humantestis}) * Locate: semimiferous
  tubules, spermatozoa
\item
  Human sperm smear (Figure \ref{fig:sperm}) * Identify: sperm, sperm
...
\item
  ...
  gastrula are the 1. \texttt{\_\_\_\_\_\_\_\_\_\_}
...
characteristic of the three-domain method is the separation of Archaea
and Bacteria, previously grouped into the single kingdom Bacteria (a
kingdom also sometimes called Monera), with the Eukaryota for all
organisms whose cells contain a nucleus.

(ref:classification)
\href{https://commons.wikimedia.org/wiki/File:Biological_classification_L_Pengo_vflip.svg}{Biological
classification.}
...
\caption{(ref:classification)}\label{fig:classification}
\end{figure}
...
(ref:tree)
\href{https://commons.wikimedia.org/wiki/File:CollapsedtreeLabels-simplified.svg}{The
tree of life.}
...
\caption{(ref:tree)}\label{fig:tree}
\end{figure}
...
(ref:phylogeny)
\href{https://commons.wikimedia.org/wiki/File:Phylogenetic-Groups.svg}{Phylogenetic
groups.}
...
\caption{(ref:phylogeny)}\label{fig:phylogeny}
\end{figure}
...
(ref:clock)
\href{https://commons.wikimedia.org/wiki/File:Geologic_Clock_with_events_and_periods.svg}{Geologic
clock.}
...
\caption{(ref:clock)}\label{fig:clock}
\end{figure}
