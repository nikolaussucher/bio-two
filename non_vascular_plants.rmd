...
knitr::include_graphics("./figures/mosses/Haeckel_Muscinae.png")
```
...
knitr::include_graphics("./figures/mosses/moss_archegonium.png")
```

```{r mossantheridium, fig.cap='Moss antheridium.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/mosses/moss_antheridium.png")
```

```{r mosscapsule, fig.cap='Moss mature capsule.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/mosses/moss_capsule.png")
```
...
knitr::include_graphics("./figures/mosses/Haeckel_Hepaticae.png")
```
...
knitr::include_graphics("./figures/mosses/liverwort_life_cycle.png")
```
...
knitr::include_graphics("./figures/mosses/Haeckel_Filicinae_92.png")
```
...
knitr::include_graphics("./figures/mosses/selaginella_strobilus.png")
```
...
knitr::include_graphics("./figures/mosses/equisetum_strobilus.png")
```
...
```{r psilotumsporangium, fig.cap='*Psilotum* sporangium.', echo=FALSE, message=FALSE, warning=FALSE}
    knitr::include_graphics("./figures/mosses/psilotum_sporangium.png")
```
...
```{r cyrtomium, fig.cap='*Cyrtomium* falcatum sorus on leaf.', echo=FALSE, message=FALSE, warning=FALSE}
    knitr::include_graphics("./figures/mosses/cyrtomium_sorus.png")
```
