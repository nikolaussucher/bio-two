...
knitr::include_graphics("./figures/fungi/peziza_apothecium.jpg")
```

```{r yeast, fig.cap='Yeast.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/fungi/yeast.jpg")
```
...
knitr::include_graphics("./figures/fungi/basidia.jpg")
```
...
knitr::include_graphics("./figures/fungi/rhizopus_sporangia.jpg")
```
...
knitr::include_graphics("./figures/fungi/rhizopus_conjugation.jpg")
```
...
knitr::include_graphics("./figures/fungi/Haeckel_Lichenes.jpg")
```
...
knitr::include_graphics("./figures/fungi/foliose_lichen.jpg")
```
