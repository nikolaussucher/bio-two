...
2.  *Clonorchis sinensis* eggs (Figure \@ref(fig:clonorchis_eggs)).
    * Identify: oral and ventral suckers, pharynx, esophagus, dead-end intestine, reproductive structures, excretory pore
...
```{r clonorchis_eggs, fig.cap='Clonorchis sinensis eggs.', echo=FALSE, message=FALSE, warning=FALSE}
...
```{r clam, fig.cap='Clam', echo=FALSE, message=FALSE, warning=FALSE}
...
16. Locate the labial palps, flaplike structures that surround and guide food into the clam's mouth. The palps are anterior to the gills & ventral to the anterior adductor muscle. Between the palps, find the mouth.
