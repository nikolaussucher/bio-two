...
knitr::include_graphics("./figures/rotifera/dugesia.png")
```

```{r dugesiaxs, fig.cap='*Dugesia* cross section through pharynx region.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/rotifera/dugesia_xs.png")
```
...
knitr::include_graphics("./figures/rotifera/taenia_scolex.png")
```

```{r proglottid, fig.cap='*Taenia* proglottid.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/rotifera/taenia_proglottids.png")
```

```{r gravid, fig.cap='*Taenia* gravid proglottid.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/rotifera/taenia_gravid_proglottid.png")
```

```{r cysticercus, fig.cap='*Taenia solium* cysticercus.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/rotifera/taenia_solium_cysticercus.png")
```
...
knitr::include_graphics("./figures/rotifera/clonorchis_sinensis_wm.png")
```

```{r fasciola, fig.cap='Fasciola hepatica.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/rotifera/fasciola_hepatica.png")
```
...
knitr::include_graphics("./figures/rotifera/cercaria.png")
```
...
knitr::include_graphics("./figures/rotifera/snail_radula.png")
```
...
knitr::include_graphics("./figures/rotifera/clam.png")
```
...
knitr::include_graphics("./figures/rotifera/earthworm.png")
```
