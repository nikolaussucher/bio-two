...
7.  Determine the sex of your specimen:
    *   Female: The urogenital opening in the female is immediately ventral to the anus and has a small genital papilla marking its location (Figure \@ref(fig:female)).
    *   Male: The scrotal sac is ventral to the anus (Figure \@ref(fig:male)) and a urogenital opening is just posterior to the umbilical cord .
...
```{r female, fig.cap='View of the urogenital papilla and anus of the female pig.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pig/pig_female.jpg")
```

```{r male, fig.cap='View of anus of the male pig.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pig/pig_male.jpg")
```

```{r pig, fig.cap='Overview of the abdominal and thoracic cavities and the neck area.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pig/pig.jpg")
```

```{r female, fig.cap='Close-up of the uterus and ovaries.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pig/pig_uterus.jpg")
```

```{r male, fig.cap='Close-up of the testes.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pig/pig_testes.jpg")
```

```{r neck, fig.cap='Close-up of the neck area.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pig/pig_neck.jpg")
```
...
4.  What are the shapes of two major parts of the colon in the pig?
