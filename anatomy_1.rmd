...
```{r urogenital, fig.cap='View of the urogenital papilla and anus of the female pig.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/pig/pig_female.jpg")
```

```{r anus, fig.cap='View of anus of the male pig.', echo=FALSE, message=FALSE, warning=FALSE}
