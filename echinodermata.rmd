...
knitr::include_graphics("./figures/echinodermata/starfish.png")
```
...
knitr::include_graphics("./figures/echinodermata/starfish_tubefeet.png")
```

```{r pedicellariae, fig.cap='Starfish pedicellariae.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/echinodermata/pedicellariae.png")
```
...
(ref:ascidians) [Ascicians](https://commons.wikimedia.org/wiki/File:Haeckel_Ascidiae.jpg)

```{r ascidians, fig.cap='(ref:ascidians)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/echinodermata/Haeckel_Ascidiae.png")
```
...
knitr::include_graphics("./figures/echinodermata/ascidian_larva.png")
```
...
knitr::include_graphics("./figures/echinodermata/lancelet_wm.png")
```

```{r lanceletxs, fig.cap='Lancelet cross section.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/echinodermata/lancelet_xs.png")
```
