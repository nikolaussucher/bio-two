...
knitr::include_graphics("./figures/development/starfish_development.png")
```
...
knitr::include_graphics("./figures/development/frog_early_cleavage.png")
```

```{r blastula, fig.cap='Frog blastula.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/frog_blastula.png")
```

```{r plug, fig.cap='Frog gastrulation with yolk plug.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/frog_gastrula_yolk_plug.png")
```

```{r gastrula, fig.cap='Frog gastrula.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/frog_gastrula.png")
```

```{r groove, fig.cap='Frog neural groove.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/frog_neural_groove.png")
```

```{r tube, fig.cap='Frog neural tube.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/development/frog_neural_tube.png")
```
