...
knitr::include_graphics("./figures/porifera/sponges.png")
```
...
knitr::include_graphics("./figures/porifera/grantia_xs.png")
```

```{r grantials, fig.cap='*Grantia* longitudinal section.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/porifera/grantia_ls.png")
```

```{r spicules, fig.cap='Spicules.', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/porifera/spicules.png")
```
...
knitr::include_graphics("./figures/porifera/chrysaora_colorata.png")
```
...
knitr::include_graphics("./figures/porifera/anthopleura_xanthogrammica.png")
```
...
(ref:nematocyst) [A firing *Hydra* nematocyst.](https://commons.wikimedia.org/wiki/File:Hydra_nematocyst_firing_01.png)

```{r nematocyst, fig.cap='(ref:nematocyst)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/porifera/nematocyst.png")
```
...
knitr::include_graphics("./figures/porifera/hydra.png")
```
...
knitr::include_graphics("./figures/porifera/hydra_xs.png")
```

```{r spermary, fig.cap='Hydra spermary', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/porifera/hydra_spermary.png")
```
...
knitr::include_graphics("./figures/porifera/aurelia_planula.png")
```

```{r scyphistoma, fig.cap='Aurelia scyphistoma', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/porifera/aurelia_scyphistoma.png")
```

```{r strobilus, fig.cap='Aurelia strobilus', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/porifera/aurelia_strobilus.png")
```
...
knitr::include_graphics("./figures/porifera/obelia_geniculata.png")
```
...
knitr::include_graphics("./figures/porifera/obelia_medusa.png")
```

(ref:obeliacolony) *Obelia* colony.

```{r obeliacolony, fig.cap='(ref:obeliacolony)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/porifera/obelia_wm.png")
```
...
knitr::include_graphics("./figures/porifera/metridium_live.png")
```
...
knitr::include_graphics("./figures/porifera/metridium.png")
```
