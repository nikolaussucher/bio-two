...
\includeonly{acknowledgements, course_description, how_to, safety}


\begin{document}
\frontmatter

% include the cover as title page
\includepdf[pages={1}]{bio_ii_cover.pdf}
...
\addcontentsline{toc}{chapter}{How to do well in this
class}
